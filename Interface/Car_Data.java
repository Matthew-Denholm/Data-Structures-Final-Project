...
import javax.swing.*;
/**
 * Write a description of class Car_Data here.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class Car_Data extends Car_Screen
{
    ...
    private JLabel ModelT = new JLabel("Name of Car Model: ", SwingConstants.RIGHT);
    private JLabel BrandT = new JLabel("Brand of Car: ", SwingConstants.RIGHT);
    private JLabel MSRPT = new JLabel("Manufacturer Standard Retail Price: ", SwingConstants.RIGHT);
    private JLabel SellT = new JLabel("Price Car was Sold: ", SwingConstants.RIGHT);
    private JLabel ComT = new JLabel("Commission Amount (Profit): ", SwingConstants.RIGHT);
    private JLabel ColorT = new JLabel("Color of Car: ", SwingConstants.RIGHT);
    private JLabel StatusT = new JLabel("Status of Car: ", SwingConstants.RIGHT);
    private JLabel MilesT = new JLabel("Number of Miles Traveled so Far: ", SwingConstants.RIGHT);
    private JLabel YearT = new JLabel("Year of Car Model: ", SwingConstants.RIGHT);
    /**
     * Constructor for objects of class Car_Data
     */
    public Car_Data()
    {
        super.hideScreen();
    ...
    model.setText(carArray[0].getModel());
    brand.setText(carArray[0].getBrand());
    sell.setText("" + carArray[0].getMSRP());
    buy.setText("" + carArray[0].getPrice());
    profit.setText("" + carArray[0].getCom());
    miles.setText("" + carArray[0].getMiles());
    year.setText("" + carArray[0].getYear());
    color.setSelectedItem(carArray[0].getColor());
    status.setSelectedItem(carArray[0].getStatus());
    }*/
    ...
    public void SaveData()
    {
        ...
        try
        {
            ...
            Cars.pushTop(carArray, carTest); //adds instance to the stack.

            Cars.setModel(carArray, modelvar);
            Cars.setBrand(carArray, brandvar);
            Cars.setMSRP(carArray, sellvar);
            Cars.setPrice(carArray, buyvar);
            Cars.setCom(carArray, profitvar);
            Cars.setMiles(carArray, mileage);
            Cars.setYear(carArray, yearvar);
            Cars.setColor(carArray, paint);
            Cars.setStatus(carArray, condition);
